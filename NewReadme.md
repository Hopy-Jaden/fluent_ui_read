...
> Reference articles  
> [Fluent 2 guidelines](https://fluent2.microsoft.design/design-principles)  
> [Build desktop apps for Window documentation](https://learn.microsoft.com/en-us/windows/apps/design/signature-experiences/design-principles)  
...
You want to know what to do. Your experiences should adapt to the device you’re on and should build off the familiar—designing for what you already understand.
   - Prioritize a functional layout that adapts seamlessly to different screen sizes and platforms.
   - Leverage native platform patterns to enhance the natural and intuitive user experience.
   - Focus development efforts on creating unique, signature experiences.
   - Create emotional experiences that are intuitive and expected, fostering a sense of reliability and trust.

**2. Built for focus and calm**  
You want to stay in the flow. ​ Your experiences should inspire action, drawing you forward, simply and seamlessly.  
   - Ensure technology are functional and empowers users to achieve their goals on their own terms.
   - App should be unobtrusive and facilitate a smooth, intuitive experience.
   - Minimize visual clutter and noise to create a calm and confident environment for users.
   - Foster a sense of emotional well-being by creating a user experience that is both functional and emotionally positive.
...
You want to be included. Your experiences should consider, learn, and reflect a range of perspectives and abilities for the benefit of all.  
   - Involve a diverse range of individuals with varying abilities and perspectives in the design process.
   - Nurture creativity and innovation for a functional and effective solution.
   - Value and understood all users to enhance sense of belonging.
